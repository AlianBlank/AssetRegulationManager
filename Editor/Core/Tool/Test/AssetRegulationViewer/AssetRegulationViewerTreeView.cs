...
namespace AssetRegulationManager.Editor.Core.Tool.Test.AssetRegulationViewer
{
    internal sealed class AssetRegulationViewerTreeView : TreeViewBase
    {
        ...
        public AssetRegulationTestTreeViewItem AddAssetRegulationTestTreeViewItem(string assetPath, string testId, AssetRegulationTestStatus status)
        {
        ...
        public AssetRegulationTestEntryTreeViewItem AddAssetRegulationTestEntryTreeViewItem(string id, string description, AssetRegulationTestStatus status, int parentId)
        {
